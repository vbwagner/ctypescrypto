...
"""
from ctypes import c_int, c_char_p, c_void_p, POINTER, c_long_long
...
class DigestType:
	...
	def oid(self):
		pass
	 	#FIXME TBD
		# return Oid(nid=libcrypto.EVP_MD_type(self.digest)
class Digest:
	"""
    ...
    def digest(self, data=None):
		"""
			...
			Optionally hashes data before finalizing
		"""
        if self.digest_finalized:
